...
> **🚧 Work in Progress:** This suite is under active development. Not all accessibility-ready checks are implemented, and those that are should be treated as a **non-exhaustive sweep** — they catch common, automatable issues but do not cover every requirement. Expect gaps, rough edges, and evolving coverage as the project matures.
